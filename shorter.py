...
# #Dosazuju podmínky podobné jako u Kalouse

# u_max = 0.2 #m/s
# L = 0.025 #Length of channel
# H = 0.005 #Height of channel
# Re = 10
...
# p, u, v, x, y
#Predepsani tlakoveho spadu a konstantni rychlosti v celem kanale
# for i in range(N+3):
#     for j in range(M+1):
#         x = -h+i*h
#         y = j*h
#         p = p_in + (p_out - p_in)/L*x
#         u = u_in
#         v = 0
#         if i == 0:
#             p = p_in
